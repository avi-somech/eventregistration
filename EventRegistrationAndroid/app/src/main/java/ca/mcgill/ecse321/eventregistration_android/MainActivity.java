...
import ca.mcgill.ecse321.eventregistration_android.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addPerson(View v) {
        ...
        HttpUtils.post("abcpersons/" + tv.getText().toString(), new RequestParams(), new JsonHttpResponseHandler() {
            @Override
    ...
    public void refreshLists(View view) {
        refreshList(personAdapter ,personNames, "abcpersons");
